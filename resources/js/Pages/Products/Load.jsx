...
export default function Load() {
    ...
    const { data, setData, post, put, errors, reset, clearErrors } = useForm({ status: 1 });
    ...
    return (
        <>
            <PrimaryButton type='button' onClick={openModal}>Cargar Productos</PrimaryButton>
            <Modal show={showModal} closeable={true} onClose={closeModal}>
                <div className="p-4">
                    <div className=" flex justify-between pb-4">
                        <h2 className=" font-semibold "> CARGAR DE BASE DE DATOS PRODUCTOS</h2>
